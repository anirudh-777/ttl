...
class Ttl < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/anirudh-777/ttl/releases/download/v#{version}/ttl-darwin-arm64"
      sha256 "REPLACE_WITH_DARWIN_ARM64_SHA256"
    end
    on_intel do
      url "https://github.com/anirudh-777/ttl/releases/download/v#{version}/ttl-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/anirudh-777/ttl/releases/download/v#{version}/ttl-linux-arm64"
      sha256 "REPLACE_WITH_LINUX_ARM64_SHA256"
    end
    on_intel do
      url "https://github.com/anirudh-777/ttl/releases/download/v#{version}/ttl-linux-amd64"
